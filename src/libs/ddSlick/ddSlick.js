(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            ...
            '.dd-options{ border:solid 1px #ccc; border-top:none; list-style:none; box-shadow:0 1px 5px #ddd; display:none; position:absolute; z-index:2000; margin:0; padding:0;background: transparent; overflow:auto;}' +
            ...
            '.dd-option:hover{ background:#f3f3f3; color:#ffffff;}' +
